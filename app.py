...
VERSIÓN 4.0 LÍNEA 11: Múltiples formatos (237, 350, 1000, 1250 CC), hasta 9 cabezales, hasta 30 tulipas
"""
...
def load_data_from_sheets():
    sheet_id = "1HmnGnWNKRNIuTOMPGeUY4bsSd-F7kO_uvLVgk05WWsc"
...
GEOMETRIA = {
    "237 CC": {
        'filas': 6,           # 6 filas (1-6)
        'columnas': 5,        # 5 columnas por cabezal
        'n_cabezales': 6,     # 6 cabezales
        'n_tulipas_por_cab': 5,
        'layout': {
            # Cada cabezal tiene tulipas distribuidas en 5 columnas × 6 filas
            # Numeración: Cabezal 1: 1-30, Cabezal 2: 31-60, etc.
            # Pero acá mostramos como si cada cabezal tuviera 1-30
        },
        'total_tulipas': 30
    },
    "350 CC": {
...
def crear_heatmaps(df_filtrado):
    """
    Crea 8 subplots (4x2): 4 formatos × 2 equipos (Desencajonadora/Encajonadora)
    Para cada formato, muestra cabezal × tulipa
    """
